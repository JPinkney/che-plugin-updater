...
exports.copyMetaYAML = exports.getLastestMetaYAMLVersion = exports.getNextVersion = void 0;
 ...
 */
function getLastestMetaYAMLVersion() {
    return fs.readFileSync('latest.txt', 'utf-8').trim();
}
exports.getLastestMetaYAMLVersion = getLastestMetaYAMLVersion;
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.updateVSCodeExtensionsJSON = exports.updateLatestTxt = void 0;
const fs = __importStar(__webpack_require__(747));
 ...
 */
function updateLatestTxt(next) {
    fs.writeFileSync('latest.txt', next);
}
exports.updateLatestTxt = updateLatestTxt;
/**
 ...
 */
function updateVSCodeExtensionsJSON(pluginMetadata) {
...
exports.updateVSCodeExtensionsJSON = updateVSCodeExtensionsJSON;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.writeNewMetaYAML = exports.createNewMetaYAML = exports.modifyPreviousMetaYAML = void 0;
const fs = __importStar(__webpack_require__(747));
 ...
 */
function modifyPreviousMetaYAML(newMetaYAML, latestVersion, nextVersion) {
...
exports.modifyPreviousMetaYAML = modifyPreviousMetaYAML;
/**
 * Update the vscode-extensions.json file with the newest version
 * @param latestVersion The latest version available in the che plugin registry
 * @param nextVersion The next version that will be available on the che plugin registry
 */
function createNewMetaYAML(latestVersion, nextVersion) {
...
const create_1 = __webpack_require__(18);
const update_1 = __webpack_require__(56);
const modify_1 = __webpack_require__(67);
/**
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const inputs = validate_1.validateInputs();
            const next = create_1.getNextVersion();
            process.chdir(path.join('che-plugin-registry', 'v3', 'plugins', inputs.pluginPath));
            const latest = create_1.getLastestMetaYAMLVersion();
            create_1.copyMetaYAML(latest, next);
            const newMetadata = modify_1.createNewMetaYAML(latest, next);
            modify_1.writeNewMetaYAML(newMetadata);
            update_1.updateLatestTxt(next);
            update_1.updateVSCodeExtensionsJSON(newMetadata);
